...
LEARNING_RATE_RANGE = np.linspace(1e-7, 1e-3, 20)
...
for LEARNING_RATE in LEARNING_RATE_RANGE:
    ...
    title = 'Test CM'
    cm = utils.plot_confusion_matrix(model, test_dataset, False)
    show = False
    ...
    if show:
        plt.show()
    plt.savefig(GRAPHS_DIR + INVESTIGATION_NAME + 'cm_' + MODEL_NAME + '.png')
