...
CLASSIFIER_DROPOUT_RANGE = np.linspace(0,0.9,9)
print(CLASSIFIER_DROPOUT_RANGE)
...
INVESTIGATION_NAME = 'coarse_dropout/'
...
for CLASSIFIER_DROPOUT in CLASSIFIER_DROPOUT_RANGE:
    MODEL_NAME = 'DO=' + str(CLASSIFIER_DROPOUT)  # Name to save model
